...
INSERT INTO "new_Item" ("categoriaId", "descricao", "disponivel", "id", "imagemUrl", "nome", "order", "preco", "precoG", "precoGComBorda", "precoGG", "precoGGComBorda", "precoM", "precoMComBorda", "precoP", "precoPComBorda") SELECT "categoriaId", "descricao", "disponivel", "id", "imagemUrl", "nome", "order", "preco", "precoG", "precoGComBorda", "precoGG", "precoGGComBorda", "precoM", "precoMComBorda", "precoP", "precoPComBorda" FROM "Item";
DROP TABLE "Item";
